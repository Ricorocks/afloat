      ...
      <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
        ...
        <div class="flex">
          <div class="relative flex items-center gap-x-4 rounded-full px-4 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
            <span class="font-semibold text-brandblue">{{ $content->shoutout_text_1 }}</span>
            <span class="h-4 w-px bg-gray-900/10" aria-hidden="true"></span>
            <a href="{{ $content->shoutout_link }}" class="flex items-center gap-x-1">
              <span class="absolute inset-0" aria-hidden="true"></span>
              {{ $content->shoutout_text_2 }}
        ...
        @endif
        <h1 class="mt-10 max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">{{ $content->title }}</h1>
        ...
        <div class="mt-10 flex items-center gap-x-6">
          ...
          @include('layouts.pagecomponents.buttonpair')
        </div>
      </div>
