<div class="mt-32">
    ...
    <div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
      <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-600">USE: <a class="text-brandblue font-bold" href="https://tailwindui.com/components/marketing/sections/heroes">https://tailwindui.com/components/marketing/sections/heroes</a> Esse id magna consectetur fugiat non dolor in ad laboris magna laborum ea consequat. Nisi irure aliquip nisi adipisicing veniam voluptate id. In veniam incididunt ex veniam adipisicing sit.</p>
